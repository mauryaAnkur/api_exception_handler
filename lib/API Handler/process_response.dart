...
dynamic processResponse(http.Response response) {
  switch (response.statusCode) {
    ...
    case 407: /// Proxy authentication required
      throw ProxyAuthenticationRequiredException(jsonDecode(response.body)['message']);
    ...
    case 413: /// Request entity too large
      throw RequestEntityTooLargeException(jsonDecode(response.body)['message']);
    ...
    case 416: /// Request range not satisfiable
      throw RequestedRangeNotSatisfiableException(jsonDecode(response.body)['message']);
    case 417: /// Exception failed
      throw FailedException(jsonDecode(response.body)['message']);
    case 419: /// Missing arguments
      throw MissingArgumentsException(jsonDecode(response.body)['message']);
    case 420: /// Invalid  arguments
    ...
    case 505: /// HTTP version not supported
      throw HttpVersionNotSupportedException(jsonDecode(response.body)['message']);
    case 550: /// Initialization failure
      throw InitializationFailureException(jsonDecode(response.body)['message']);
    default:
